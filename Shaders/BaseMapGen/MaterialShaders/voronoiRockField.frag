...
void main( void )
{
    ...
    */
    /*
    albedoHeight.r = 0.129 * colorModulator + 0.003;
    albedoHeight.g = 0.109 * colorModulator + 0.001;
    albedoHeight.b = 0.107 * colorModulator + 0.001;
    */
    
    albedoHeight.rgb = modulatedColor * colorModulator + baseColor * perlinNoise * 8.0;
