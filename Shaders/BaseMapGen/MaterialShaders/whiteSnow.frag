...
void main( void )
{
    ...
    */
    ...
    float noiseValue = pow(FBMPeriodicWithFreq(gl_FragCoord.xy / 2048.0 + vec2(brseedAbs - 6), 1000.0) * 600,5) - 0.3;
    noiseValue += pow(FBMPeriodicWithFreq(gl_FragCoord.xy / 2048.0 + vec2(brseedAbs - 7), 1000.0) * 550,4);

    albedo.r = 0.990 - noiseValue * noiseColor.r * 0.3;
    albedo.g = 0.990 - noiseValue * noiseColor.g * 0.3;
    albedo.b = 0.994 - noiseValue * noiseColor.b * 0.3;
    
    height = sandFloor + 0.5;
