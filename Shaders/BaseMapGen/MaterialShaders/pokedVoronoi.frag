...
void main( void )
{
    ...
    float smoothnessValue = abs(perlinNoise) + 0.3;
    float colorModulator = abs(highFreqPerlinNoise) + 0.2;
    colorModulator *= colorModulator;
    
    albedoHeight.rgb = vec3(0.0119,0.0122,0.0117) * colorModulator + rockColor * (1 - max(0,colorModulator));
