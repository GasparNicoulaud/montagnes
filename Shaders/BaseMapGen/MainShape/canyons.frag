...
void main(void)
{
    ...
    float sqrtPlainsNoise = abs(basicFBMWithRotations(gl_FragCoord.xy * globalFreq,brseedAbs)) * globalAmp;
    sqrtPlainsNoise = min(sqrtPlainsNoise,(0.6 + basicFBMWithRotations(gl_FragCoord.xy * globalFreq * 0.1,brseedAbs + 2) * 0.1) * globalAmp);
    ...
    */
    ...
    out_Color = vec4(sqrtPlainsNoise,0,0,1.0);
