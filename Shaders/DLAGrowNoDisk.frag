...
uint checkSurroundings(const ivec3 zeroOneMinusOne, ivec2 fragCoord)
{
    ...
    nbc += texelFetchOffset(sampler, fragCoord, 0, ivec2(-3,7)).r & 1U;
    ...
    nbc += texelFetchOffset(sampler, fragCoord, 0, ivec2(-5,6)).r & 1U;
    ...
    nbc += texelFetchOffset(sampler, fragCoord, 0, ivec2(-6,5)).r & 1U;
    ...
    nbc += texelFetchOffset(sampler, fragCoord, 0, ivec2(-7,3)).r & 1U;
